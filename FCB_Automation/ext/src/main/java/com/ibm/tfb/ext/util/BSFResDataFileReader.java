...
public class BSFResDataFileReader extends DPFTFileReader {

	public BSFResDataFileReader(String dir, ResFileDataLayoutDbo resFileDataLayoutDbo, String chal_name) {
