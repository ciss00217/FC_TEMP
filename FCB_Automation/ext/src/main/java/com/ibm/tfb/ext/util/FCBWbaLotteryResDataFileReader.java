...
public class FCBWbaLotteryResDataFileReader extends DPFTFileReader {

	public FCBWbaLotteryResDataFileReader(String dir, ResFileDataLayoutDbo resFileDataLayoutDbo, String chal_name) {
