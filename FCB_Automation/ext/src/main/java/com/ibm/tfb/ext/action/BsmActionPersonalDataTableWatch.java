...
public class BsmActionPersonalDataTableWatch extends DPFTActionTableWatch {
	...
	public void postAction() throws DPFTRuntimeException {
		...
		DPFTOutboundDboSet oMsgSet = (DPFTOutboundDboSet) connector.getDboSet("O_BSM", qString);
		oMsgSet.load();
		...
		TFBUtil.generateObndCtrlRecord(connector, oMsgSet, cell_code_list, cell_name_list, "BSM", false);
		oMsgSet.close();
		dMsgSet.clear();
