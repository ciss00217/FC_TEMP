...
public class SemActionPersonalDataTableWatch extends DPFTActionTableWatch {
	...
	public void postAction() throws DPFTRuntimeException {
		...
		DPFTOutboundDboSet oEdmSet = (DPFTOutboundDboSet) connector.getDboSet("O_SEM", qString);
		oEdmSet.load();
...
//			String email = "";
			...
			if (dEdm.isNull("email_priority")) {
				...
				email = custSet.getPrioritizedEmail(dEdm.getString("customer_id"), "SEM",
		...
		TFBUtil.processUsageCode(oEdmSet, "SEM");

		/* Write results to H_OUTBOUND Table */
		TFBUtil.generateObndCtrlRecord(connector, oEdmSet, cell_code_list, cell_name_list, "SEM", true);
		oEdmSet.close();
		dEdmSet.close(); 
