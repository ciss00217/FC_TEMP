...
public class SsmFileFormatter extends DPFTCSVFileFormatter {
	private String header = null;

	public SsmFileFormatter(DPFTFileMetaData h_meta, DPFTFileMetaData d_meta, String header) {
		super(h_meta, d_meta);
		this.header = header;
	}
	...
	public void format(DPFTDboSet rs) throws DPFTRuntimeException {
		...
		if(data_string != null){
			//concat SSM header at first line
