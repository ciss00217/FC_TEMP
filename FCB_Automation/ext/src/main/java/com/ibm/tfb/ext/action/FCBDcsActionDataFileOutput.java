...
import com.ibm.tfb.ext.util.FCBDcsFileFormatter;

public class FCBDcsActionDataFileOutput extends DPFTActionDataFileOutput {
	
	@Override
	public DPFTFileFormatter getFileFormatter() throws DPFTRuntimeException {
		return new FCBDcsFileFormatter(new DPFTFileMetaData(meta), new DPFTFileMetaData(meta, dicSet));
	}
