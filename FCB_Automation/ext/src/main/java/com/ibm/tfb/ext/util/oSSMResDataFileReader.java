...
public class oSSMResDataFileReader extends DPFTFileReader {

	public oSSMResDataFileReader(String dir, ResFileDataLayoutDbo resFileDataLayoutDbo, String chal_name) {
